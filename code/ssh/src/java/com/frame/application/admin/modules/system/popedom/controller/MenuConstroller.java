...
import com.frame.application.admin.modules.system.popedom.model.MenuTreeBean;
import com.frame.application.admin.modules.system.popedom.service.MenuService;
 ...
 */
@Controller
@RequestMapping(SystemConstants.PROJECT_PATH + "system/popedom/menu/")
public class MenuConstroller extends BaseController{
	...
	public String toAddMenu(String parentNo, ModelMap model)
	{
		...
		return "system/popedom/menu/addMenu";
	}
	...
	{
		return "system/popedom/menu/menuFrame";
	}
	...
	{
		model.put("parentNo", parentNo);
		return "system/popedom/menu/menuList";
	}
