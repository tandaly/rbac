 ...
 */
@Controller
@RequestMapping(SystemConstants.PROJECT_PATH + "system/popedom/user/")
public class UserConstroller extends BaseController{
	...
	{
		return "system/popedom/user/addUser";
	}
	...
	public void addUser(HttpServletResponse response, User user, String confirmPassword)
	{
	...
	public String toUpdateUser(Long id, ModelMap model)
	{
		...
		return "system/popedom/user/updateUser";
	}
	...
	public void updateUser(HttpServletResponse response, User user, String confirmPassword)
	{
		Map<String, Object> result = new HashMap<String, Object>();
	...
	{
		return "system/popedom/user/userList";
	}
