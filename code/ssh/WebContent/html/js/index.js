//加载js
app_checkloadjscssfile("./js/changeSkin.js", "js"); 

/* 本页自定义css */
app_checkloadjscssfile("./css/index.css", "css");
...
$(window).load(function(){	
	var defaultHome = "http://www.hujiang.com/bulozt/dream_season/autumn/#!/4/page-one";
