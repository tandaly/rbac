...
/******************************************导入页面必须的文件 start**************************************/
//文件中导入ico文件
var icoFile = '<link rel="Shortcut Icon" href="./images/logo.ico" type="image/x-icon">';
document.write(icoFile);

//css文件中导入css文件
var cssFile = '<link rel="stylesheet" type="text/css" href="./css/common.css">';
document.write(cssFile);

//文件中导入js文件
var jsFile = '<script type="text/javascript" src="./js/jquery.js"><\/script>';
document.write(jsFile);
var jsFile2 = '<script type="text/javascript" src="./js/backspace.js"><\/script>';
