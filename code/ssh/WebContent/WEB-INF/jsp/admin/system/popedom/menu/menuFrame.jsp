		...
		<script type="text/javascript">
			...
			var setting = {
				...
				callback: {
					onClick: function (event, treeId, treeNode){
						...
						{
							$("#rightFrame").attr("src", "admin/system/popedom/menu/toMenuList.do?parentNo="+(treeNode.treeId == null?"1":treeNode.treeId));
						}
			...
			function initTree() {
				$.ajax({  
			   		...
			   		dataType : "json",
			   		async:false,
			   		url: "admin/system/popedom/menu/ajaxGetMenusTree.do",//请求的action路径
			   		data: {"flag":true},  
		...
		<div style="width:100%;height:100%;">
			...
			<div id="rightFrameContainer">
				<iframe onload="" name="rightFrame" id="rightFrame"
					style="display: ;" src="admin/system/popedom/menu/toMenuList.do?parentNo=1" frameborder="no" scrolling="auto"
					hidefocus=""></iframe>
			</div>
		</div>
	<style type="text/css">
