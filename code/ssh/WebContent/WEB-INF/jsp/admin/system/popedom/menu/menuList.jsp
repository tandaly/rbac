		...
		<script type="text/javascript">
			...
			$(function(){
				...
				myPagination = $("#pageDiv").myPagination({
					...
					{
					  on: true,
					  url: "admin/system/popedom/menu/ajaxMenuList.do",
					  dataType: 'json',
					  param:formData,
					  ajaxStart:function(){
			...
			function createTR(no, obj)
			{
				...
				tr += "<td style=\"text-align: center;\" width=\"160px;\">"
					+"<a href=\"admin/system/popedom/menu/toUpdateMenu.do?id="+obj.id+"\">修改</a>&nbsp;&nbsp;<a href=\"javascript:deleteMenu("+obj.id+")\">删除</a>"
					+"</td>";
				return tr;
			...
			function deleteMenu(id)
			{
				if(confirm('你是否要删除该记录?'))
				{
					$.ajax({
						type: "post",
						url: "admin/system/popedom/menu/deleteMenu.do?id="+id,
	...
	<body>
		<div class="toolbg toolbgline toolheight nowrap">
			<div class="nowrap left">
				<a class="btn_gray btn_space" href="javascript:location.href='${pageContext.request.contextPath}/admin/system/popedom/menu/toAddMenu.do?parentNo='+$('#parentNo').val();">新增</a>
